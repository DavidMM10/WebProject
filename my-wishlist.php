...
<?php include('includes/footer.php');?>
	...
	<section class="section featured-product inner-xs wow fadeInUp">
		<h3 class="section-title">El mejor juego de tu wishlist es</h3>
		<div class="owl-carousel best-seller custom-carousel owl-theme outer-top-xs">
			<?php


//$ret=mysqli_query($con,"select * from wishlist");
//from wishlist INNER JOIN products ON wishlist.productId=products.id INNER JOIN productreviews ON products.id=product.Id AND quality=5");
//SELECT * FROM `wishlist` ORDER BY `quality` DESC 
//where category=8

//$ret=mysqli_query($con,"select * from products INNER JOIN wishlist ON products.id=wishlist.productId");

//$ret=mysqli_query($con,"select * from wishlist INNER JOIN products ON wishlist.productId=products.id LIMIT 1");

$ret=mysqli_query($con,"select * from products INNER JOIN wishlist 
ON products.id=wishlist.productId ORDER BY DESC");
