...
<!-- ============================================== INFO BOXES : END ============================================== -->		
		...
		<div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs  wow fadeInUp">
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Juegos disponibles</h3>
...
<?php
$ret=mysqli_query($con,"select * from products where category=7 and subCategory=8");
while ($row=mysqli_fetch_array($ret)) 
{
?>
...
<?php }?>
					...
					<div class="col-md-6">
						<section class="section">
		                   	...
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="21">
	<?php
$ret=mysqli_query($con,"select * from products where category=8 and subCategory=8");
while ($row=mysqli_fetch_array($ret)) 
{
?>
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="product-details.php?pid=<?php echo htmlentities($row['id']);?>"><img  src="juegos/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" data-echo="juegos/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>"  width="300" height="300"></a>
			</div><!-- /.image -->			                        		   
		</div><!-- /.product-image -->
...
<?php }?>
		...
		<h3 class="section-title">Juegos con mejor calificacion</h3>
...
?>
	...
	<section class="section featured-product inner-xs wow fadeInUp">
		<h3 class="section-title">Juegos con peor calificacion</h3>
		<div class="owl-carousel best-seller custom-carousel owl-theme outer-top-xs">
			<?php
$ret=mysqli_query($con,"select * from products where category=8 AND subcategory=20");
